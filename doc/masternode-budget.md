...
Format: ```mngovernance prepare proposal-name url payment-count block-start wagerr-address monthly-payment-wagerr```
...
Format: ```mngovernance submit proposal-name url payment-count block-start wagerr-address monthly-payment-wagerr fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using wagerr.conf setup)
