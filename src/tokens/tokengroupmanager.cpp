...
void CTokenGroupManager::ResetTokenGroups() {
    ...
    CTokenGroupInfo tgInfoWGR(NoGroup, (CAmount)GroupAuthorityFlags::ALL);
    CTransaction tgTxWgr;
    std::shared_ptr<CTokenGroupDescriptionRegular> tgDescriptionWGR = std::make_shared<CTokenGroupDescriptionRegular>("WGR", "Wgr", 8, "https://wagerr.com", uint256());
