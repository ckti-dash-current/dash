...
#include "zwagerr/accumulatormap.h"
#include "zwagerr/accumulatorcheckpoints.h"
#include "zwagerr/witness.h"
#include "zwagerr/zwagerrchain.h"
#include "zwagerr/zerocoindb.h"
...
/*
    ...
    //It is VERY IMPORTANT that when this is being run and height < v2_start, then zWAGERR need to be disabled at the same time!!
