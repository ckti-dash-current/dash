...
def build():
    ...
    if args.windows:
        ...
        subprocess.check_call('mv build/out/wagerr-*-win-unsigned.tar.gz inputs/wagerr-win-unsigned.tar.gz', shell=True)
    ...
    if args.macos:
        ...
        subprocess.check_call('mv build/out/wagerr-*-osx-unsigned.tar.gz inputs/wagerr-osx-unsigned.tar.gz', shell=True)
